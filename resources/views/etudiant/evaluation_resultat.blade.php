                            ...
                            <p>
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col">
                                        ...
                                        @if ($request->input('vf'.$vf->id) == 'vrai')

                                        @if ($request->input('vf'.$vf->id) == $vf->reponse)

                                            <span class="text-success">Vrai (bonne réponse)</span>
                                            @php
                                                $compte = $compte + 1;
                                            @endphp
                                        @else
                                        <span class="text-danger">Vrai (mauvaise réponse)</span>
                                        @endif
                                    ...
                                    <div class="col">
                                        ...
                                        @if ($request->input('vf'.$vf->id) == 'faux')

                                        @if ($request->input('vf'.$vf->id) == $vf->reponse)

                                            <span class="text-success">Faux (bonne réponse)</span>
                                            @php
                                                $compte = $compte + 1;
                                            @endphp
                                        @else
                                        <span class="text-danger">Faux (mauvaise réponse)</span>
                                        @endif
