...
<body>
 ...
 @php
  ...
  <a href="{{ route('liste_classe_matiere_lecon_trace_etudiant',['id' => $user->id ,'id_c' => $classe->id , 'id_m' => $matiere->id ,'id_l' => $lecon->id]) }}" class="btn btn-success btn"><h5>Précédent</h5> </a>


                        </div>
                        <div class="col-4">
                            <a href="{{ route('liste_classe_matiere_lecon_evaluation_etudiant',['id' => $user->id ,'id_c' => $classe->id , 'id_m' => $matiere->id ,'id_l' => $lecon->id]) }}" class="btn btn-success btn"><h5>Suivant</h5> </a>
