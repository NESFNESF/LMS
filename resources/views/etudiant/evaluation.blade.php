        ...
        <div class="content mt-3 ml-0">
            <div class="animated fadeIn">
                ...
                <div class="social-buttons">
                    <form class="form" action = "{{route('liste_classe_matiere_lecon_evaluation_resultat_etudiant',['id' => $user->id ,'id_c' => $classe->id , 'id_m' => $matiere->id ,'id_l' => $lecon->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                <div class="row justify-content-between">
                                    <div class="col">
                                        <input name="qcm{{ $qcm->id }}" type="radio" value="{{ $qcm->qcm1 }}" required/> {{ $qcm->qcm1 }}

                                    </div>
                                    <div class="col">
                                        <input name="qcm{{ $qcm->id }}" type="radio" value="{{ $qcm->qcm2 }}" required/> {{ $qcm->qcm2 }}
                                    </div>
                                    <div class="col">
                                        <input name="qcm{{ $qcm->id }}" type="radio" value="{{ $qcm->qcm3 }}" required/> {{ $qcm->qcm3 }}
                                    </div>
                                 </div>
                            ...
                            <p>
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col">
                                        <input name="vf{{ $vf->id }}" type="radio" value="vrai" required/>  Vrai

                                    </div>
                                    <div class="col">
                                        <input name="vf{{ $vf->id }}" type="radio" value="faux" required/> Faux
                                    </div>
                                 </div>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col">
                            ...
                            <input type="submit" class="btn btn-success btn" value="VOIR MES RÉSULTATS">
