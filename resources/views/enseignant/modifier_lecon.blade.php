            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Modifier la leçon {{ $lecon->titre }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-xs-10 col-sm-10">
                        <div class="card">
                            ...
                            <form class="form" action = "{{route('store_modifier_lecon',['id' => $user->id ,'id_c' => $classe->id , 'id_m' => $matiere->id , 'id_l' => $lecon->id])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class=" form-control-label">Titre de la leçon : </label>
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                                    <input class="form-control" type="text" name="titre" required value="{{ $lecon->titre }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    -Connaitre le web"> @foreach (explode('$',DB::table('objectifs')->where('idL' , $lecon->id)->get()[0]->description) as $obj){{ $obj }} $@endforeach</textarea>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    -peut répondre à plusieurs questions sur le web ">@foreach (explode('$',DB::table('indicateurs')->where('idL' , $lecon->id)->get()[0]->description) as $ind){{ $ind }} $@endforeach</textarea>
                                </textarea>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                                    <textarea class="form-control" name="situation" rows="4" required placeholder="Saisisez votre texte ici...">@foreach (explode('$',DB::table('situations')->where('idL' , $lecon->id)->get()[0]->description) as $sit){{ $sit }} $@endforeach</textarea>
                                </textarea>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                                    <textarea class="form-control" name="trace" rows="4" required placeholder="Saisisez votre texte ici...">@foreach (explode('$',DB::table('traces')->where('idL' , $lecon->id)->get()[0]->titre) as $trace){{ $trace }} $@endforeach</textarea>
                                </textarea>
                                </div>
