                                            ...
                                            @endif
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <h2 class="text-light display-6">Leçcon {{$a}}</h2>
                                                ...
                                                <blockquote class="blockquote text-justify mb-0 text-light">
                                                    <p class=" text-center">{{$lecon->titre}}</p>
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item">
                                                        <i class="fa fa-phone-square"></i> Date de création : <span class="badge badge-primary pull-right">{{ $lecon->created_at }}</span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-5">
                                                                <a href="{{ route('liste_classe_matiere_modifierlecon_enseignant',['id' => $user->id ,'id_c' => $classe->id , 'id_m' => $matiere->id  , 'id_l' => $lecon->id]) }}" class="btn btn-danger btn-sm">Modifier la leçon</a>
