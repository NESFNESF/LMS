                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active"><a href="{{route('liste_classe_enseignant',$user->id) }}">Liste des Classes/</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row justify-content-between">
                                                    <div class="col-4">
                                                        ...
                                                        <a href="{{ route('liste_classe_matiere_enseignant',['id' => $user->id ,'id_c' => $class->id ]) }}" class="btn btn-primary btn-sm">Matières  </a>

                                                    </div>
                                                    <div class="col-4">
                                                        <a href="{{ route('liste_classe_eleve',['id' => $user->id ,'id_c' => $class->id ]) }}" class="btn btn-success btn-sm">Liste élèves</a>
